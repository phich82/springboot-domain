package com.sonha.kafka.consumer;

import com.sonha.kafka.config.data.KafkaConfigData;
import com.sonha.kafka.config.data.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public KafkaConsumerConfig(KafkaConfigData kafkaConfigData, KafkaConsumerConfigData kafkaConsumerConfigData) {
        ...
        System.out.println("KafkaConsumerConfig => kafkaConfigData => " + kafkaConfigData);
        System.out.println("KafkaConsumerConfig => kafkaConsumerConfigData => " + kafkaConsumerConfigData);
    }
    ...
    public Map<String, Object> consumerConfig() {
        ...
        System.out.println("KafkaConsumerConfig => props => " + props);
        return props;
    }
