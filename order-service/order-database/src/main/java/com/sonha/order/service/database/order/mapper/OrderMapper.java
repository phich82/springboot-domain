package com.sonha.order.service.database.order.mapper;
...
import com.sonha.order.service.database.order.entity.OrderAddressEntity;
import com.sonha.order.service.database.order.entity.OrderEntity;
import com.sonha.order.service.database.order.entity.OrderItemEntity;
...
public class OrderMapper {
    ...
    private List<OrderItemEntity> orderItemsToOrderItemEntities(List<OrderItem> items) {
        return items.stream().map(orderItem -> OrderItemEntity.builder()
                ...
                .quantity(orderItem.getQuanlity())
