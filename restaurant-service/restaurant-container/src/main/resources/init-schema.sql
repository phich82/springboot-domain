...
------------------ APPROVAL_STATUS DATA TYPE ------------------
DROP TYPE IF EXISTS approval_status;

CREATE TYPE approval_status AS ENUM ('APPROVED', 'REJECTED');

-- Fix ERROR: column "approval_status" is of type approval_status but expression is of type character varying
...
ALTER TABLE restaurants.shc_restaurant_product
    ADD CONSTRAINT "FK_SHC_RESTAURANT_ID" FOREIGN KEY (restaurant_id)
